...
export const config = {
  ...
  SICES_START_ENDPOINT: publicConfigValue("SICES_START_ENDPOINT", "https://auth.demokracija-20.si/api/sices/start"),
  SICES_COMPLETE_ENDPOINT: publicConfigValue("SICES_COMPLETE_ENDPOINT", "https://auth.demokracija-20.si/api/sices/complete"),
  ...
  TURNSTILE_SITE_KEY: publicConfigValue("TURNSTILE_SITE_KEY", publicConfigValue("CLOUDFLARE_TURNSTILE_SITE_KEY")),
  TURNSTILE_ENDPOINT: publicConfigValue("TURNSTILE_ENDPOINT", "/api/security/turnstile"),
